...
module common_mod
    ...
    type grid_type             ! derived grid type
        ...
        integer, pointer :: active(:,:,:)           ! point to active cell in 1d array for Cartesian; 
                                                    ! returns 0 for inactive cells        
        integer, pointer :: activeR(:,:)            ! reverse point from active cell 
                                                    ! returns 0 for inactive cells        
        integer, pointer :: activeV(:)              ! points to active cell in 1d array for Voronoi;
                                                    ! returns 0 for inactive cells
        integer, pointer :: activeRV(:)           ! reverse point from active cell 

        type(Vertex), pointer :: voronoi(:)         ! pointer to voronoi cell array
        ...
        real, pointer :: volume(:,:,:)              ! volume of Cartisian cell (ix,iy,iz)
        real, pointer :: volumeV(:)                 ! volume of Voronoi cell (cell)
        real, pointer :: massV(:)                   ! mass of Voronoi cell (cell)
        real, pointer :: positionV(:,:)             ! position of Voronoi cell (cell, 1:3) where 1 = x, 2 = y, 3 = z        
        ...
        real, pointer :: ionDen(:,:,:)              ! fractional ion density (cell,elem,stage)
        ...
        real, pointer :: linePackets(:,:)           ! line packets (cell,n)
    ...
    integer, pointer   :: starIndecesV(:)  ! (nstars)
